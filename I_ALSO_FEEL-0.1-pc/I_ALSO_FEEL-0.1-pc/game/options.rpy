...
define config.name = _("I_ALSO_FEEL")
...
define gui.about = _p("""Эта игра - поток мыслей, оформленных за трое суток
...
define config.main_menu_music = "music/Produce.mp3"
...
define config.save_directory = "I_ALSO_FEEL_ver0.1"
